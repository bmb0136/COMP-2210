...
public class Term implements Comparable<Term> {
    ...
    public static Comparator<Term> byDescendingWeightOrder() {
        return (a, b) -> -Long.compare(a.weight, b.weight);
    }
    ...
    public static Comparator<Term> byPrefixOrder(int length) {
        ...
        return (a, b) -> {
            String aq = a.query.substring(0, Math.min(a.query.length(), length));
            String bq = b.query.substring(0, Math.min(b.query.length(), length));
